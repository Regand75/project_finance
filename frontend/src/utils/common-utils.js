export class CommonUtils {
    ...
    static generateGridToolsColumn(entity, id, category) {
        return `<div class="${entity}-tools">
                    <a href="#/${entity}/delete?id=${id}&category=${category}" class="${entity}-delete">
                        <!-- Иконка удаления -->
                    ...
                    <a href="#/${entity}/edit?id=${id}&category=${category}" class="${entity}-edit">
